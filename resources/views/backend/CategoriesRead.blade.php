...
<!-- đổ dữ liệu bên dưới vào tag yield("do-du-lieu-vao-layout") trong file Layout.blade.php -->
@section("do-du-lieu-vao-layout")
<div class="col-md-6 col-xs-offset-3">
	<div style="margin-bottom: 5px;"><a class="btn btn-primary" href="{{ url('admin/categories/create') }}">Add Categories</a></div>
